...
var javascriptblend = new Action({
	...
	perform: function(options, done, started) {
	    ...
	    for (var i = 0, l = files.length; i < l; i++) {
	    	...
	    	if (options.optimize && _.indexOf(options.optimize, files[i].basename) > -1) {
	    ...
	    //fsext.remove(options.root, options.globs); //speeds up subsequent builds if source files are left in
